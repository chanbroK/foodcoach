...
public class GetNutriInfoPieChart extends AppCompatActivity {
    ...
    private Button btn_cal_nutrition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cal_nutrition.setOnClickListener(v -> {
            // Intent intent = new Intent(GetNutritionInfo.this, ShowNutritionInfoByPolarChart.class);
            Intent intent = new Intent(GetNutriInfoPieChart.this, ShowNutritionInfoByPolarChart.class);
    ...
    private String getURI(String barcode) {
        ...
        String uri = "urn:epc:idpat:sgtin:";
